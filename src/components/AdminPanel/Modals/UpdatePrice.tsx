...
export default function UpdatePrice({
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto font-iran-sans"
        onClose={closeModal}
      >
          ...
          >
            <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start mb-16">
                ...
                <div className="mt-3 ml-6 text-center sm:mt-0 sm:mr-4 sm:text-right">
                  <Dialog.Title
                    as="h4"
                    className=" leading-6 font-medium text-gray-900 "
                  >
                    {
                      'برخی از مقادیر تغییر کرده‌اند درصورت ادامه تغیرات ذخیره نمی شوند'
                    }
                  </Dialog.Title>
